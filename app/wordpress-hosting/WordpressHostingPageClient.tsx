...
export default function WordpressHostingPageClient() {
  useEffect(() => {
    ...
    if (!(window as any).__whnz_wordpress_hosting_TabsInit) {
      (window as any).__whnz_wordpress_hosting_TabsInit = true;
    ...
    const tryRunScripts = () => {
      if (!jqLoaded) return;
      if ((window as any).__whnz_wordpress_hosting_ScriptsRan) return;
      (window as any).__whnz_wordpress_hosting_ScriptsRan = true;
      try {
